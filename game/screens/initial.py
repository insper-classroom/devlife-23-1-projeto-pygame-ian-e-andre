...
class Initial:
    def __init__(self, window):
        ...
        self.groups["buttons"].add(Button(window, self.start_game, "START GAME", [WINDOW_WIDTH / 2 - BOX_BUTTON_WIDTH / 2, 150], "b2"))
        self.groups["buttons"].add(Button(window, self.open_store, "STORE", [WINDOW_WIDTH / 2 - BOX_BUTTON_WIDTH / 2, 230], "b1"))
